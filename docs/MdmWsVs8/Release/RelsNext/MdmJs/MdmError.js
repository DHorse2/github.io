...
function ErrorAnalysis(eventFileNamePassed, eventFileLinePassed, eventFileColumnPassed,
    ...
    if (errorSeverityPassed >= errorIsFatal) {
        ...
        if (errorDebugLevel < 1 + errorSeverityPassed || UseDebugOnError) { UseDebugNext = DoUseDebug; }
        ...
        if (errorDebugLevel < 1 + errorSeverityPassed) { UseDebugNext = DoUseDebug; }
    } else {
        // errorIsComment:
...
function WindowErrorDebug(eventCurrPassed, messagePassed, eventFileNamePassed, eventFileLinePassed, eventFileColumnPassed, DoUseAlertPassed, UseDebugPassed) {
    ...
    //
    if (UseDebugNext || UseDebugOnError || UseDebugOnAll) {
